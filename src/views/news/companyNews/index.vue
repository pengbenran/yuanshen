  ...
  <div class="app-container">
    <el-row class="warp">
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true">
          <el-form-item>
            <el-button type="primary" @click="toNewsAdd" v-if="newsList.length<3">新增新闻</el-button>
          </el-form-item>
        </el-form>
      </el-col>
      ...
      <el-table :data="newsList" highlight-current-row style="width: 100%;">
        ...
        <el-table-column label="操作" :width="200">
          <template slot-scope="scope">
            <el-button size="mini" @click="toNewsEdit(scope.row.id)">编辑</el-button>
  ...
  export default {
    ...
    //删除新闻列表
     removeNews(id){
      ...
      toNewsEdit(id){
        let that = this;
        that.$router.push({ path: 'companyNews/newsEdit?id='+id})
      },
      // 新增
      toNewsAdd(){
        let that = this;
