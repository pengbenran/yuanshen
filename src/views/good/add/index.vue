...
<div class="app-container">
  <el-form :model="AddData"  :rules="AddDatarules" ref="AddruleForm">
    ...
    <el-form-item label="所属分类" :label-width="formLabelWidth"  prop="catName">
      <el-select v-model="AddData.catName1" clearable placeholder="请选择">
        <el-option v-for="item in goodsCatRoot" :key="item.value" :label="item.name" :value="item.catId"></el-option>
      </el-select>
      <el-select v-model="AddData.catName2" clearable placeholder="请选择" :disabled = "goodCatChilerBool">
    ...
    <el-form-item label="展示销售量" :label-width="formLabelWidth"  prop="showSales">
      <el-input v-model="AddData.showSales" placeholder="请输入销量" autocomplete="off"></el-input>
    </el-form-item> 
    <el-form-item label="材质" :label-width="formLabelWidth"  prop="material">
      <el-input v-model="AddData.material" placeholder="请输入材质" autocomplete="off"></el-input>
    </el-form-item> 
    <el-form-item label="尺寸" :label-width="formLabelWidth"  prop="size">
      <el-input v-model="AddData.size" placeholder="请输入尺寸" autocomplete="off"></el-input>
    </el-form-item>      
    <el-form-item label="说明" :label-width="formLabelWidth"  prop="intro">
      <el-input v-model="AddData.intro" placeholder="请输入商品说明" autocomplete="off"></el-input>
    </el-form-item>          
    <el-form-item label="商品图片" :label-width="formLabelWidth"  prop="images">
      <div class="avatar-uploader imagesBoxList" v-for="(item,index) in AddData.imagesList" :key="item" :index='index'>
  ...
  <div slot="footer" class="dialog-footer">
    ...
    <el-button type="primary">上架商品</el-button>
  </div>
</div>
</template>
<script>
